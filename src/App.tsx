                    ...
                    <div style={{ color: 'var(--text-muted)', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                      ...
                      >
                        <svg viewBox="0 0 24 24" width="24" height="24" fill="#25D366" xmlns="http://www.w3.org/2000/svg">
                          <path d="M12.031 6.172c-3.181 0-5.767 2.586-5.768 5.766-.001 1.298.38 2.27 1.019 3.287l-.711 2.598 2.654-.698c.93.509 1.842.779 2.803.78h.004c3.181 0 5.767-2.586 5.768-5.766.001-3.18-2.587-5.767-5.769-5.767zm-7.992 5.767c0-1.708.665-3.323 1.867-4.546 1.218-1.242 2.85-1.926 4.606-1.926 3.582 0 6.496 2.914 6.497 6.497 0 1.745-.691 3.429-1.916 4.613-1.22 1.181-2.825 1.832-4.579 1.832h-.004c-.818-.001-1.625-.221-2.339-.638l-4.116 1.083 1.096-4.008c-.452-.782-.693-1.68-.691-2.588-.002-.109-.009-.215-.021-.319zm11.366 3.193c-.159-.08-1.144-5.65-1.32-.628-.178-.079-.307-.118-.426.061-.119.179-.456.575-.559.694-.103.119-.204.135-.362.057-.16-.081-.665-.246-1.268-.784-.469-.418-.785-.935-.877-1.093-.092-.159-.01-.246.069-.325.071-.07.159-.179.238-.268.08-.089.106-.151.159-.251.053-.101.027-.19-.013-.269-.04-.079-.387-.935-.531-1.28-.139-.335-.281-.29-.385-.295-.1-.005-.213-.005-.327-.005-.113 0-.297.042-.452.211-.155.169-.59.576-.59 1.402 0 .826.601 1.624.685 1.743.084.118 1.183 1.808 2.87 2.536 1.687.728 1.687.485 1.992.455.305-.03 1.144-.468 1.304-.92.161-.452.161-.839.113-.92-.048-.08-.181-.132-.382-.232z" />
                        </svg>
                        +57 318 376 3021
                      </a>
                      <a
                        href="https://wa.me/573003859125"
                        target="_blank"
                        rel="noopener noreferrer"
                        style={{ color: 'inherit', textDecoration: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '0.5rem' }}
                        onMouseOver={(e) => e.currentTarget.style.textDecoration = 'underline'}
          ...
          <div className="footer-content">
            <div className="footer-section">
              ...
              <div className="social-links">
                <a
                  href="https://x.com/BcodeConsulTeam"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <a
                  href="https://www.tiktok.com/@bcodeteam"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="social-link"
                  title={t('footer.followTikTok')}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
